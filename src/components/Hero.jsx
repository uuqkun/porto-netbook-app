...
const Hero = () => (
  <section className="flex md:flex-row flex-col my-10">
    ...
    <div className={`flex-1 ${layout.flexStart} flex-col lg:mb-0 mb-10`}>
      ...
      <h1
        className={`${font.heading1} text-heading font-bold font-quicksand leading-[50px] md:leading-[65px] mb-4`}
      >
      ...
      <div>
        <Button
          value="About More"
          classes="bg-primary text-white shadow-button mr-4"
        />
        <Button
          value="Invite Friends"
          classes="text-primary border-[1px] border-primary"
        />
      </div>
    </div>
